...
namespace AppAwm.Migrations
{
    ...
    [Migration("20241125181849_AjusteV03")]
    partial class AjusteV03
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AppAwm.Models.Cargo", b =>
                {
                    ...
                    b.Property<int?>("FuncionarioCd_Funcionario")
                        .HasColumnType("INT");
                    ...
                    b.HasIndex("FuncionarioCd_Funcionario");
            ...
            modelBuilder.Entity("AppAwm.Models.Cargo", b =>
                {
                    b.HasOne("AppAwm.Models.Funcionario", "Funcionario")
                        .WithMany("Cargos")
                        .HasForeignKey("FuncionarioCd_Funcionario");
