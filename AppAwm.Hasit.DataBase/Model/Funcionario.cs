...
namespace AppAwm.Hasit.DataBase.Model
{
    ...
    public class Funcionario
    {
        ...
        [Display(Name = "PIS")]
        [Column("PISPASEP", TypeName = "VARCHAR(15)", Order = 10)]
        public string? PisPasep { get; set; }

        [Display(Name = "Sexo")]
        [Column("SEXO", TypeName = "VARCHAR(1)", Order = 15)]
        [Required(AllowEmptyStrings = false, ErrorMessage = "Selecione o sexo do colaborador.")]
        public string? Sexo { get; set; }

        [Display(Name = "Estado Civil")]
        [Column("ESTADOCIVIL", TypeName = "INT", Order = 20)]
        [Range(1, 10, ErrorMessage = "Selecione o estado civl.")]
        ...
        [Range(1, 20000, ErrorMessage = "Selecione o Cargo/Função.")]
        public int? Cd_Cargo { get; set; }

        [Display(Name = "Salário")]
        [Column("REMUNERACAO", TypeName = "DECIMAL(8,2)", Order = 45)]
        ...
        //public virtual Cargo Cargo { get; } = new();
